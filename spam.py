# DƯƠNG HỮU QUYỀN ĐẸP TRAI SỐ 1 HÀ TĨNH 
...
def banner():
  ...
  for h in ban:
    ...
    time.sleep(0.003)
banner()
sdt = input("Nhập số điện thoại mà bạn ghét : ")
while not re.search("^(0?)(3[2-9]|5[6|8|9]|7[0|6-9]|8[0-6|8|9]|9[0-4|6-9])[0-9]{7}$",sdt):
  print("Nhập sai định dạng số")
  sdt = input("Nhập số điện thoại mà bạn ghét : ")
count = int(input("Nhập số lần muốn spam đến cháy máy : "))
if sdt == "0932399207":
  print("Sài tool của đại ca quyền mà đòi spam sms của đại ca quyền à con ")
  quit()
